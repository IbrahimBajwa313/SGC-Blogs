      ...
      <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 gap-y-10 pb-12 border-b border-gray-700 px-4 lg:px-12">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="flex space-x-4 mt-4 sm:mt-8">
            <Link href="#">
              <i className="fab fa-facebook text-2xl lg:text-3xl text-gray-400 hover:text-blue-600 transition-colors duration-200 ease-in-out"></i>
            </Link>
            <Link href="#">
              <i className="fa-brands fa-youtube ml-4 lg:ml-8 text-2xl lg:text-3xl text-gray-400 hover:text-red-500 transition-colors duration-200 ease-in-out"></i>
            </Link>
            <Link href="#">
              <i className="fab fa-twitter ml-4 lg:ml-8 text-2xl lg:text-3xl text-gray-400 hover:text-blue-400 transition-colors duration-200 ease-in-out"></i>
            </Link>
            <Link href="#">
              <i className="fa-brands fa-instagram ml-4 lg:ml-8 text-2xl lg:text-3xl text-gray-400 hover:text-pink-700 transition-colors duration-200 ease-in-out"></i>
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-400 mb-3">
            Dont miss to subscribe to our new feeds. Kindly fill the form below.
          </p>
